...
-- Tiempo de generación: 16-09-2025 a las 23:19:54
...
INSERT INTO `cita` (`id_cita`, `id_paciente`, `id_doctor`, `fecha`, `hora`, `motivo`, `estado`) VALUES
(1, 1, 2, '2023-10-15', '09:30:00', 'Control anual', 'completada'),
(2, 2, 1, '2023-10-16', '10:15:00', 'Dolor en el pecho', 'programada'),
(3, 3, 3, '2023-10-17', '11:00:00', 'Erupción cutánea', 'cancelada'),
(4, 4, 5, '2023-10-18', '14:30:00', 'Dolor en la rodilla', 'programada'),
(5, 5, 4, '2023-10-19', '15:45:00', 'Control ginecológico', 'programada'),
(6, 6, 6, '2023-10-20', '16:30:00', 'Dolores de cabeza frecuentes', 'programada'),
(7, 7, 7, '2023-10-21', '17:15:00', 'Revisión de vista', 'programada');
...
INSERT INTO `diagnostico` (`id_diagnostico`, `id_cita`, `diagnostico`, `tratamiento`, `notas`) VALUES
(1, 1, 'Paciente en buen estado de salud', 'Continuar con dieta balanceada y ejercicio regular', 'Control anual sin complicaciones'),
(2, 2, 'Taquicardia sinusal', 'Reposo y medicación betabloqueante', 'Revisar en una semana');
...
INSERT INTO `doctor` (`id_doctor`, `nombre`, `apellido`, `id_especialidad`, `telefono`, `email`) VALUES
(1, 'Carlos', 'Mendoza', 1, '555-1234', 'cmendoza@hospital.com'),
(2, 'Ana', 'Gutiérrez', 2, '555-5678', 'agutierrez@hospital.com'),
(3, 'Roberto', 'Silva', 3, '555-9012', 'rsilva@hospital.com'),
(4, 'Laura', 'Díaz', 4, '555-3456', 'ldiaz@hospital.com'),
(5, 'Miguel', 'Torres', 5, '555-7890', 'mtorres@hospital.com'),
(6, 'Elena', 'Rojas', 6, '555-2468', 'erojas@hospital.com'),
(7, 'Javier', 'Ortega', 7, '555-1357', 'jortega@hospital.com');
...
INSERT INTO `enfermero` (`id_enfermero`, `nombre`, `apellido`, `telefono`, `email`, `turno`) VALUES
(1, 'Elena', 'Ruiz', '555-1122', 'eruiz@hospital.com', 'tarde'),
(2, 'Jorge', 'Vargas', '555-3344', 'jvargas@hospital.com', 'noche'),
(3, 'Carmen', 'Diaz', '555-5566', 'cdiaz@hospital.com', 'mañana'),
(4, 'Pedro', 'Santos', '555-7788', 'psantos@hospital.com', 'tarde'),
(5, 'Lucía', 'Morales', '555-9900', 'lmorales@hospital.com', 'noche');
...
(1, 'Cardiología', 'Especialidad médica que se ocupa del corazón y el sistema circulatorio'),
(2, 'Pediatría', 'Cuidado médico de niños y adolescentes'),
(3, 'Dermatología', 'Diagnóstico y tratamiento de enfermedades de la piel'),
(4, 'Ginecología', 'Salud del sistema reproductor femenino'),
(5, 'Traumatología', 'Tratamiento de lesiones musculoesqueléticas'),
...
INSERT INTO `habitacion` (`id_habitacion`, `numero`, `tipo`, `estado`, `piso`) VALUES
(1, '101', 'individual', 'disponible', 1),
(2, '102', 'individual', 'disponible', 1),
(3, '103', 'individual', 'disponible', 1),
(4, '201', 'doble', 'disponible', 2),
(5, '202', 'doble', 'ocupada', 2),
(6, '203', 'doble', 'disponible', 2),
(7, '301', 'suite', 'mantenimiento', 3),
(8, '302', 'suite', 'disponible', 3);
...
INSERT INTO `historial_cambios` (`id_historial`, `tabla_afectada`, `id_registro_afectado`, `accion`, `fecha_cambio`, `id_usuario`, `datos_anteriores`, `datos_nuevos`) VALUES
(1, 'cita', 3, 'UPDATE', '2025-09-08 16:04:21', 1, 'estado: programada', 'estado: cancelada'),
(2, 'paciente', 2, 'UPDATE', '2025-09-08 16:04:21', 2, 'telefono: 555-2222', 'telefono: 555-2223');
...
INSERT INTO `ingreso` (`id_ingreso`, `id_paciente`, `id_habitacion`, `fecha_ingreso`, `fecha_alta`, `motivo`, `diagnostico_ingreso`) VALUES
(1, 1, 2, '2023-10-10 14:30:00', NULL, 'Observación por dolor abdominal', 'Dolor abdominal inespecífico, requiere observación'),
(2, 2, 4, '2023-10-11 10:15:00', '2023-10-15 09:00:00', 'Cirugía de corazón', 'Intervención quirúrgica exitosa, paciente en recuperación'),
(3, 5, 5, '2023-10-12 11:30:00', NULL, 'Parto programado', 'Embarazo de 39 semanas, trabajo de parto iniciado'),
(4, 5, 6, '2025-09-04 00:00:00', '2025-09-03 00:00:00', 'calculo renal', 'dolores indeterminados');
...
(1, 'Paracetamol', 'Analgésico y antipirético', 100, 5.50),
(2, 'Ibuprofeno', 'Antiinflamatorio no esteroideo', 80, 7.20),
(3, 'Amoxicilina', 'Antibiótico de amplio espectro', 50, 12.80),
(4, 'Omeprazol', 'Protector gástrico', 120, 9.90),
(5, 'Atorvastatina', 'Para reducir el colesterol', 75, 15.30),
(6, 'Metformina', 'Para la diabetes tipo 2', 90, 8.45),
(7, 'Losartán', 'Para la hipertensión arterial', 110, 10.75);
...
INSERT INTO `paciente` (`id_paciente`, `nombre`, `apellido`, `fecha_nacimiento`, `direccion`, `telefono`, `id_sexo`, `id_estado_civil`) VALUES
(1, 'María', 'García', '1985-03-15', 'Av. Principal 123', '555-1111', 2, 2),
(2, 'Juan', 'Pérez', '1978-07-22', 'Calle Secundaria 456', '555-2222', 1, 1),
(3, 'Sofía', 'López', '1992-11-05', 'Jr. Norte 789', '555-3333', 2, 3),
(4, 'Luis', 'Martínez', '1982-09-18', 'Av. Sur 321', '555-4444', 1, 4),
(5, 'Carmen', 'Vargas', '1975-12-30', 'Av. Este 654', '555-5555', 2, 2),
(6, 'Ricardo', 'Fernández', '1988-04-25', 'Jr. Oeste 987', '555-6666', 1, 1),
(7, 'Isabel', 'Dominguez', '1995-08-12', 'Calle Central 741', '555-7777', 2, 5);
...
INSERT INTO `procedimiento` (`id_procedimiento`, `nombre`, `descripcion`, `duracion_estimada`, `costo`) VALUES
(1, 'Ecografía abdominal', 'Examen de imagen para visualizar órganos abdominales', 30, 150.00),
(2, 'Electrocardiograma', 'Registro de la actividad eléctrica del corazón', 20, 85.50),
(3, 'Endoscopia', 'Exploración visual del tracto digestivo superior', 45, 320.00),
(4, 'Resonancia magnética', 'Imágenes detalladas de órganos y estructuras internas', 60, 450.00),
(5, 'Tomografía computarizada', 'Imágenes transversales del cuerpo', 30, 380.00);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `procedimiento_realizado`
--
...
--
-- Volcado de datos para la tabla `procedimiento_realizado`
--

INSERT INTO `procedimiento_realizado` (`id_procedimiento_realizado`, `id_paciente`, `id_doctor`, `id_procedimiento`, `fecha`, `observaciones`) VALUES
(1, 1, 2, 1, '2023-10-10', 'Resultados dentro de parámetros normales'),
(2, 2, 1, 2, '2023-10-12', 'Se detectaron arritmias leves, requiere seguimiento'),
(3, 4, 5, 3, '2023-10-13', 'Hallazgos normales, sin complicaciones');
...
INSERT INTO `receta` (`id_receta`, `id_cita`, `fecha`, `instrucciones`) VALUES
(1, 1, '2023-10-15', 'Tomar después de los alimentos. No consumir alcohol durante el tratamiento.'),
(2, 2, '2023-10-16', 'Tomar en ayunas. Monitorear frecuencia cardíaca.');
...
INSERT INTO `receta_medicamento` (`id_receta_medicamento`, `id_receta`, `id_medicamento`, `dosis`, `frecuencia`, `duracion`) VALUES
(1, 1, 1, '500 mg', 'Cada 8 horas', 5),
(2, 1, 3, '250 mg', 'Cada 12 horas', 7),
(3, 2, 5, '20 mg', 'Una vez al día', 30),
(4, 2, 7, '50 mg', 'Una vez al día', 30);
...
(2, 'Doctor', 'Puede gestionar pacientes, citas y diagnósticos'),
(3, 'Enfermero', 'Puede gestionar ingresos y administrar medicamentos'),
(4, 'Recepcionista', 'Puede gestionar citas y pacientes');
...
CREATE TABLE `usuario` (
  ...
  `tipo_personal` enum('doctor','enfermero','administrativo') DEFAULT NULL,
...
INSERT INTO `usuario` (`id_usuario`, `username`, `password`, `id_rol`, `id_personal`, `tipo_personal`, `activo`) VALUES
(1, 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, NULL, 'administrativo', 1),
(2, 'cmendoza', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 2, 1, 'doctor', 1),
(3, 'agutierrez', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 2, 2, 'doctor', 1),
(4, 'eruiz', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 3, 1, 'enfermero', 1);
...
--
-- Indices de la tabla `procedimiento_realizado`
--
ALTER TABLE `procedimiento_realizado`
...
ALTER TABLE `sexo`
  ...
  ADD UNIQUE KEY `tipo_sexo` (`tipo_sexo`);
...
--
-- AUTO_INCREMENT de la tabla `procedimiento_realizado`
--
ALTER TABLE `procedimiento_realizado`
  MODIFY `id_procedimiento_realizado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `receta_medicamento`
  MODIFY `id_receta_medicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `diagnostico`
  ADD CONSTRAINT `diagnostico_ibfk_1` FOREIGN KEY (`id_cita`) REFERENCES `cita` (`id_cita`);
...
--
ALTER TABLE `historial_cambios`
  ADD CONSTRAINT `historial_cambios_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);
...
--
ALTER TABLE `paciente`
  ADD CONSTRAINT `paciente_ibfk_1` FOREIGN KEY (`id_sexo`) REFERENCES `sexo` (`id_sexo`),
  ADD CONSTRAINT `paciente_ibfk_2` FOREIGN KEY (`id_estado_civil`) REFERENCES `estado_civil` (`id_estado_civil`);

--
-- Filtros para la tabla `procedimiento_realizado`
--
ALTER TABLE `procedimiento_realizado`
  ADD CONSTRAINT `procedimiento_realizado_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `paciente` (`id_paciente`),
  ADD CONSTRAINT `procedimiento_realizado_ibfk_2` FOREIGN KEY (`id_doctor`) REFERENCES `doctor` (`id_doctor`),
  ADD CONSTRAINT `procedimiento_realizado_ibfk_3` FOREIGN KEY (`id_procedimiento`) REFERENCES `procedimiento` (`id_procedimiento`);

--
-- Filtros para la tabla `receta`
--
ALTER TABLE `receta`
  ADD CONSTRAINT `receta_ibfk_1` FOREIGN KEY (`id_cita`) REFERENCES `cita` (`id_cita`);

--
-- Filtros para la tabla `receta_medicamento`
--
ALTER TABLE `receta_medicamento`
  ADD CONSTRAINT `receta_medicamento_ibfk_1` FOREIGN KEY (`id_receta`) REFERENCES `receta` (`id_receta`),
  ADD CONSTRAINT `receta_medicamento_ibfk_2` FOREIGN KEY (`id_medicamento`) REFERENCES `medicamento` (`id_medicamento`);
...
CREATE TABLE `reservations` (
  ...
  `num_students` int(11) NOT NULL,
  `practice_area` enum('cuidados básicos','valoración','heridas y quirúrgica','pediatría','ginecobstetricia','debriefing','reanimación') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `reservations` (`id`, `laboratorio`, `fecha`, `hora_inicio`, `hora_fin`, `teacher_name`, `practice_type`, `materials`, `num_students`, `practice_area`) VALUES
(44, 'promocion-salud-sexual-reproductiva', '2025-08-05', '08:00:00', '10:00:00', 'CARLOS', 'INFECTOLOGÍA', 'WERTYIOP', 34, 'pediatría'),
(46, 'promocion-salud-infantil-adolescente', '2025-08-05', '02:00:00', '04:00:00', 'JUAN', 'REANIMACIÓN', 'MUÑECO, CARRO PAROS, ETC', 23, 'reanimación'),
(47, 'Valoración del estado de la salud', '2025-08-05', '08:00:00', '10:00:00', 'MIGUEL', 'PYP', 'N/A', 23, 'valoración'),
(48, 'Valoración del estado de la salud', '2025-08-05', '10:00:00', '12:00:00', 'DIEGO', 'TT', 'JERINGAS', 23, 'valoración');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `reservations_history`
--
...
INSERT INTO `usuarios` (`id`, `username`, `password_hash`, `created_at`) VALUES
(3, 'admin', '$2y$10$JRDLyKFxf6YKqvIZbXut0OZpjnP6pkzwDEk3vPAiP7gisOt36G7Q2', '2025-07-28 20:53:26');
...
--
-- Indices de la tabla `reservations_history`
--
ALTER TABLE `reservations_history`
  ADD PRIMARY KEY (`id`,`deletion_date`);
...
(651, 'padilla', '2025-08-29', 'ximena'),
(701, 'padilla', '2025-08-29', 'ximena'),
(751, 'padilla', '2025-08-29', 'ximena'),
(801, 'padilla', '2025-08-29', 'ximena'),
(851, 'padilla', '2025-08-29', 'ximena'),
(901, 'padilla', '2025-08-29', 'ximena');
...
('root', '[{\"db\":\"sistema_enfermeria\",\"table\":\"sisterma_enfermeria_users\"},{\"db\":\"laboratory_reservations\",\"table\":\"reservations\"},{\"db\":\"laboratory_reservations\",\"table\":\"reservations_history\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__central_columns\"},{\"db\":\"reservas_laboratorios\",\"table\":\"reservas\"},{\"db\":\"biblioteca\",\"table\":\"libro\"},{\"db\":\"biblioteca\",\"table\":\"autor\"},{\"db\":\"colegio\",\"table\":\"estudiante_curso\"},{\"db\":\"library_db\",\"table\":\"libros\"},{\"db\":\"crud_simple_db\",\"table\":\"persona\"}]');
...
('root', '2025-05-30 20:58:31', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\",\"NavigationWidth\":239.993}');
...
ALTER TABLE `reservas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- Base de datos: `sistema_enfermeria`
--
CREATE DATABASE IF NOT EXISTS `sistema_enfermeria` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sistema_enfermeria`;
...
CREATE TABLE `pacientes` (
  ...
  `tipo_eps` varchar(50) NOT NULL,
  `contacto_emergencia` varchar(100) NOT NULL,
  `telefono_emergencia` varchar(50) NOT NULL,
  `presion_arterial` varchar(100) NOT NULL,
  `frecuencia_respiratoria` varchar(100) NOT NULL,
  `frecuencia_cardiaca` varchar(100) NOT NULL,
  `temperatura_corporal` varchar(100) NOT NULL,
  `saturacion_oxigeno` varchar(100) NOT NULL,
...
INSERT INTO `pacientes` (`id_paciente`, `nombres`, `apellidos`, `f_nacimiento`, `edad`, `estado_civil`, `genero`, `telefono`, `telefono_2`, `email`, `email_2`, `direccion`, `barrio`, `ciudad`, `departamento`, `nacionalidad`, `eps`, `tipo_eps`, `contacto_emergencia`, `telefono_emergencia`, `presion_arterial`, `frecuencia_respiratoria`, `frecuencia_cardiaca`, `temperatura_corporal`, `saturacion_oxigeno`, `observaciones`) VALUES
(1, 'brayan eduardo', 'ariza torres', '2007-11-06', 17, 'soltero', 'm', '1234567890', '', 'celestejym888@mailbox.biz.st', 'celestejym888@mailbox.biz.st', 'calle 12 # 45-13', 'villa palmas', 'palmas del socorro', 'santander', 'colombia', 'nueva eps', 'contributivo', 'ivan ramiro cordoba', '1234567890', '117/79', '80', '110', '35', '97', 'ninguna');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `sisterma_enfermeria_users`
--

CREATE TABLE `sisterma_enfermeria_users` (
  `ID` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `sisterma_enfermeria_users`
--

INSERT INTO `sisterma_enfermeria_users` (`ID`, `username`, `password`, `email`, `fullname`, `groupid`, `active`, `ext_security_id`) VALUES
(1, 'enfermera1', '1qazxsw2', 'enfermera1@unisangil.edu.co', 'Natalia Alianovna Romanova', '1', NULL, NULL);
...
--
-- Indices de la tabla `sisterma_enfermeria_users`
--
ALTER TABLE `sisterma_enfermeria_users`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT de la tabla `sisterma_enfermeria_users`
--
ALTER TABLE `sisterma_enfermeria_users`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
